module.exports.playerMoving = (that, BOXSIZE) => {
  ...
  that.canvas.drawImage(
    ...
    that.positions.playerPos.HEX.PX.x - _anim.moving.offsetX, //paint to X in canvas
    that.positions.playerPos.HEX.PX.y - _anim.moving.offsetY, //paint to Y in canvas
